...
<?php if ($stats->rowCount() > 0): ?>
    ...
    <div class="dashboard-cards">
        <div class="card">
            ...
            <div class="number"><?php echo $stats->rowCount(); ?></div>
        </div>
        <?php
                ...
                <div style="margin: 0.5rem 0;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 0.25rem;">
                        <span><?php echo htmlspecialchars($dept['department']);
                                ?></span>
                        <span>Rp <?php echo number_format(
                                        $dept['avg_salary'],
                                        0,
                                        ',',
                                        '.'
...
4px; width: <?php echo ($dept['avg_salary'] / max(array_column(
                    $all_stats,
                    'avg_salary'
                )) * 100); ?>%;"></div>
                    </div>
...
4px; width: <?php echo ($dept['total_employees'] / max(array_column(
                    $all_stats,
                    'total_employees'
                )) * 100); ?>%;"></div>
                    </div>
...
<?php else: ?>
    <div style="text-align: center; padding: 3rem; background: #f8f9fa; border-radius: 8px;">
        ...
        <p style="color: #999;">Pastikan sudah ada data karyawan dan VIEW
            <code>department_stats</code> sudah dibuat di database.
        </p>
