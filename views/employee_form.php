...
$form_action = $is_edit ? "index.php?action=edit&id={$employee['id']}" :
...
<form method="POST" action="<?php echo $form_action; ?>">
    ...
    <div class="form-group">
        ...
        <select id="department" name="department" class="form-input" required>
            ...
            <option value="Operations" <?php echo ($is_edit &&
                                            $employee['department'] == 'Operations') ? 'selected' : ''; ?>>Operations</option>
            <option value="Sales" <?php echo ($is_edit && $employee['department']
                                        == 'Sales') ? 'selected' : ''; ?>>Sales</option>
        </select>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text"
            ...
            name="salary"
            class="form-input"
            value="<?php echo $is_edit ? number_format($employee['salary'], 0, ',', '.') : ''; ?>"
            required
            min="0"
            step="100000"
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        if (parseInt(salary.replace(/\D/g, '')) < 1000000) {
